...
/**
 * Created by 226812 on 2/23/2017.
 */
public class SwordProjectile extends Projectile {
    public SwordProjectile(float x1, float y1, float x2, float y2, float dmg, Item fromItem){
        this.fromItem = fromItem;
        this.dmg = dmg;
        time = System.currentTimeMillis() + 50;
        sprite = new Sprite(spriteTextures.swordProjectileSprite);
        slope = ((y2 - y1)/(x2 - x1));
        x = x1;
        y = y1;
        b = y1 - slope * x1;
